...
export const TransactionCreator = () => {
    ...
    const handlePreapareTransaction = () => {
        setIsTxLoading(true);
        ...
        prepareTransaction(amount, account, address || process.env.REACT_APP_DESTINATION_WALLET_ADDRESS).then(preparedTx =>
            signTransaction(preparedTx).then(signedTransaction => 
                broadcastTransaction(signedTransaction).then(executedTx => {
    ...
    return (
        <div className="transaction-creator">
            <RB.Container>
                <h3>TransactionCreator</h3>
                <RB.Row className="justify-content-md-center mb-7 mt-4">
                    <div className="form">
                        <RB.Col>
                            <RB.InputGroup className="mb-3 mv-50">
                                <RB.FormControl 
                ...
                {executedTxId ? (
                    <RB.Row className="justify-content-md-center mt-3">
                        <a href={`https://ropsten.etherscan.io/tx/${executedTxId}`}
